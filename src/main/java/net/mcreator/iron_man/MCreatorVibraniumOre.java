...
public class MCreatorVibraniumOre extends Elementsiron_man.ModElement {
	@ObjectHolder("iron_man:vibraniumore")
	public static final Block block = null;

	public MCreatorVibraniumOre(Elementsiron_man instance) {
		super(instance, 4);
	}
